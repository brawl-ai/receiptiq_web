import { Button, Group, Paper, Select, SelectProps, Stack, Textarea, TextInput } from "@mantine/core";
import { useForm } from "@mantine/form";
import { FieldCreate, FieldResponse, FieldType, FieldUpdate } from "../../../lib/types";
import { useEffect, useState } from "react";
import { IconAbc, IconBraces, IconBrackets, IconCalendar, IconCheck, IconNumbers, IconToggleLeft } from "@tabler/icons-react";
        ...
        <Paper withBorder p={"sm"} bd={"1px dashed blue"}>
            <form onSubmit={form.onSubmit(handleSubmit)}>
                ...
                <Group justify="flex-end" mt="xl">
                    ...
                    <Button type="submit" variant="gradient" size="compact-sm" disabled={isSubmitting} loading={isSubmitting}>
                        Save
                    </Button>
                </Group>
            </form>
